...
public class GallerySkin extends SkinBase<Gallery>
{
    ...
    public static final double CONTENT_WIDTH = 200;
    ...
    public GallerySkin(Gallery control) {
        ...
        popup = new GalleryPopup(this, control);
    ...
    private StackPane createItemContainer(GalleryItem item) {
        ...
        graphicContainer.setPrefWidth(CONTENT_WIDTH);
    ...
    private void mousePressedOnItem(StackPane graphicContainer) {
        ...
        Home.changeModule(containerItem.get(graphicContainer));
    }
    ...
    protected void layoutChildren(double x, double y, double w, double h) {
        ...
        upButton.setLayoutX(CONTENT_WIDTH * getSkinnable().getNumOfVisibleItems()- 1);
        ...
        downButton.setLayoutX(CONTENT_WIDTH * getSkinnable().getNumOfVisibleItems() - 1);
        ...
        popupButton.setLayoutX(CONTENT_WIDTH * getSkinnable().getNumOfVisibleItems() - 1);
        popupButton.setLayoutY(upButtonHeight + downButtonHeight);

        final double graphicContainerHeight = CONTENT_HEIGHT;
        graphicsContainer.resize(CONTENT_WIDTH * getSkinnable().getNumOfVisibleItems(), graphicContainerHeight);
    }

    @Override
    protected double computeMinWidth(double height, double topInset, double rightInset, double bottomInset, double leftInset) {
        double buttonWidth = upButton.prefWidth(-1);
        return leftInset + CONTENT_WIDTH * getSkinnable().getNumOfVisibleItems() + buttonWidth + rightInset;
    }
