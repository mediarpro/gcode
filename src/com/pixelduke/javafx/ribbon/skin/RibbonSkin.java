...
public class RibbonSkin extends SkinBase<Ribbon>
{
    ...
    public RibbonSkin(Ribbon control) {
        ...
        control.selectedRibbonTabProperty().addListener(new ChangeListener<RibbonTab>() {
            @Override
            public void changed(ObservableValue<? extends RibbonTab> observable, RibbonTab oldValue, RibbonTab newValue) {
